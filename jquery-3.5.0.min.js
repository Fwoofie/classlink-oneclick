!function (e, t) {
    ...
    var t = [], r = Object.getPrototypeOf, s = t.slice, v = t.flat ? function (e) {
        ...
        }, u = t.push, i = t.indexOf, n = { t: true }, o = n.toString, y = n.hasOwnProperty, a = y.toString, l = a.call(Object), m = {
            checkClone: ce.cloneNode(true).cloneNode(true).lastChild.checked,
            noCloneChecked: !!ce.cloneNode(true).lastChild.defaultValue,
            option: !!ce.lastChild,
            checkOn: '' !== dt.value,
            optSelected: ht.selected,
            radioValue: 't' === dt.value,
            focusin: 'onfocusin' in C,
            cors: !!en && 'withCredentials' in en,
            ajax: en = !!en,
            createHTMLDocument: ((tn = E.implementation.createHTMLDocument('').body).innerHTML = '<form></form><form></form>', 2 === tn.childNodes.length)
        }, x = function (e) {
    ...
    S.extend = S.fn.extend = function () {
        ...
        for ('boolean' == typeof a && (l = a, a = arguments[s] || {}, s++), 'object' == typeof a || x(a) || (a = {}), s === u && (a = this, s--); s < u; s++) {
            if (null != (e = arguments[s])) {
                for (t in e)
                    r = e[t], '__proto__' !== t && a !== r && (l && r && (S.isPlainObject(r) || (i = Array.isArray(r))) ? (n = a[t], o = i && !Array.isArray(n) ? [] : i || S.isPlainObject(n) ? n : {}, i = false, a[t] = S.extend(l, o, r)) : void 0 !== r && (a[t] = r));
            }
        }
        return a;
    };
    ...
    var d = function (n) {
        ...
        var e, d, b, o, a, h, p, g, w, u, l, T, C, s, E, v, c, y, m, S = 'sizzle' + +new Date(), x = n.document, k = 0, r = 0, A = ue(), N = ue(), D = ue(), j = ue(), q = function (e, t) {
                return e === t && (l = true), 0;
                ...
                return -1;
            }, F = '(?:\\\\[\\da-fA-F]{1,6}[\\x20\\t\\r\\n\\f]?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+', B = '\\[[\\x20\\t\\r\\n\\f]*(' + F + ')(?:' + '[\\x20\\t\\r\\n\\f]' + '*([*^$|!~]?=)' + '[\\x20\\t\\r\\n\\f]' + '*(?:\'((?:\\\\.|[^\\\\\'])*)\'|"((?:\\\\.|[^\\\\"])*)"|(' + F + '))|)' + '[\\x20\\t\\r\\n\\f]' + '*\\]', $ = ':(' + F + ')(?:\\(((\'((?:\\\\.|[^\\\\\'])*)\'|"((?:\\\\.|[^\\\\"])*)")|((?:\\\\.|[^\\\\()[\\]]|' + B + ')*)|.*)\\)|)', _ = new RegExp('[\\x20\\t\\r\\n\\f]+', 'g'), z = new RegExp('^[\\x20\\t\\r\\n\\f]+|((?:^|[^\\\\])(?:\\\\.)*)[\\x20\\t\\r\\n\\f]+$', 'g'), U = new RegExp('^[\\x20\\t\\r\\n\\f]*,[\\x20\\t\\r\\n\\f]*'), X = new RegExp('^[\\x20\\t\\r\\n\\f]*([>+~]|[\\x20\\t\\r\\n\\f])[\\x20\\t\\r\\n\\f]*'), V = new RegExp('[\\x20\\t\\r\\n\\f]|>'), G = new RegExp($), Y = new RegExp('^' + F + '$'), Q = {
                ID: new RegExp('^#(' + F + ')'),
                CLASS: new RegExp('^\\.(' + F + ')'),
                TAG: new RegExp('^(' + F + '|[*])'),
                ATTR: new RegExp('^' + B),
            ...
            if (!r && (T(t), t = t || C, E)) {
                if (11 !== p && (u = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/.exec(e))) {
                    if (i = u[1]) {
                        if (9 === p) {
                            ...
                            if (f && (a = f.getElementById(i)) && m(t, a) && a.id === i) {
                                return n.push(a), n;
                            }
                        }
                    } else {
                ...
                if (d.qsa && !j[e + ' '] && (!v || !v.test(e)) && (1 !== p || 'object' !== t.nodeName.toLowerCase())) {
                    if (c = e, f = t, 1 === p && (V.test(e) || X.test(e))) {
                        for ((f = /[+~]/.test(e) && ye(t.parentNode) || t) === t && d.scope || ((s = t.getAttribute('id')) ? s = s.replace(/([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, oe) : t.setAttribute('id', s = S)), o = (l = h(e)).length; o--;) {
                            ;
                        }
                        c = l.join(',');
                    }
        ...
        function ge(t) {
            return function (e) {
                return 'form' in e ? e.parentNode && false === e.disabled ? 'label' in e ? 'label' in e.parentNode ? e.parentNode.disabled === t : e.disabled === t : e.isDisabled === t || e.isDisabled !== !t && ae(e) === t : e.disabled === t : 'label' in e && e.disabled === t;
            };
        }
        function ve(a) {
        ...
        for (e in (d = se.support = {}, a = se.isXML = function (e) {
                ...
                return r != C && 9 === r.nodeType && r.documentElement && (s = (C = r).documentElement, E = !a(C), x != C && (n = C.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener('unload', i, false) : n.attachEvent && n.attachEvent('onunload', i)), d.scope = ce(function (e) {
                ...
                }), d.getElementsByClassName = /^[^{]+\{\s*\[native \w/.test(C.getElementsByClassName), d.getById = ce(function (e) {
                ...
                }, c = [], v = [], (d.qsa = /^[^{]+\{\s*\[native \w/.test(C.querySelectorAll)) && (ce(function (e) {
                    var t;
                    ...
                    v.push(',.*:');
                })), (d.matchesSelector = /^[^{]+\{\s*\[native \w/.test(y = s.matches || s.webkitMatchesSelector || s.mozMatchesSelector || s.oMatchesSelector || s.msMatchesSelector)) && ce(function (e) {
                    d.disconnectedMatch = y.call(e, '*');
                    y.call(e, '[s!=\'\']:x');
                    c.push('!=', $);
                }), v = v.length && new RegExp(v.join('|')), c = c.length && new RegExp(c.join('|')), t = /^[^{]+\{\s*\[native \w/.test(s.compareDocumentPosition), m = t || /^[^{]+\{\s*\[native \w/.test(s.contains) ? function (e, t) {
                ...
                if (T(e), d.matchesSelector && E && !j[t + ' '] && (!c || !c.test(t)) && (!v || !v.test(t))) {
                    try {
                        var n = y.call(e, t);
                        ...
                        return 1 === g && 0 === v ? function (e) {
                            ...
                            if (c) {
                                ...
                                if (u = [m ? c.firstChild : c.lastChild], m && p) {
                                    ...
                                    if (p && (d = s = (r = (i = (o = (a = e)[S] || (a[S] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === k && r[1]), false === d) {
                                        for (; (a = ++s && a && a[l] || (d = s = 0) || u.pop()) && ((x ? a.nodeName.toLowerCase() !== f : 1 !== a.nodeType) || !++d || (p && ((i = (o = a[S] || (a[S] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] = [
                                                k,
                                                d
                                            ]), a !== e));) {
                                            ;
        ...
        function Ee(e) {
            for (var i, t, n, r = e.length, o = b.relative[e[0].type], a = o || b.relative[' '], s = o ? 1 : 0, u = be(function (e) {
                        return e === i;
                    }, a, true), l = be(function (e) {
                        return -1 < M(i, e);
                    }, a, true), c = [function (e, t, n) {
        ...
        return me.prototype = b.filters = b.pseudos, b.setFilters = new me(), h = se.tokenize = function (e, t) {
            ...
            for (a = e, s = [], u = b.preFilter; a;) {
                for (o in (n && !(r = U.exec(a)) || (r && (a = a.slice(r[0].length) || a), s.push(i = [])), n = false, (r = X.exec(a)) && (n = r.shift(), i.push({
                        value: n,
                        type: r[0].replace(z, ' ')
            ...
            if (n = n || [], 1 === c.length) {
                ...
                for (i = Q.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !b.relative[s = a.type]);) {
                    if ((u = b.find[s]) && (r = u(a.matches[0].replace(re, f), /[+~]/.test(o[0].type) && ye(t.parentNode) || t))) {
            ...
            return (l || p(e, c))(r, t, !E, n, !t || /[+~]/.test(e) && ye(t.parentNode) || t), n;
    ...
    (S.fn.init = function (e, t, n) {
        ...
        if (n = n || j, 'string' != typeof e) {
            return e.nodeType ? (this[0] = e, this.length = 1, this) : x(e) ? void 0 !== n.ready ? n.ready(e) : e(S) : S.makeArray(e, this);
        }
        ...
        if (r[1]) {
            if (t = t instanceof S ? t[0] : t, S.merge(this, S.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : E, true)), /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i.test(r[1]) && S.isPlainObject(t)) {
                for (r in t)
    ...
    S.each({
        ...
        S.fn[r] = function (e, t) {
            ...
            return 'Until' !== r.slice(-5) && (t = e), t && 'string' == typeof t && (n = S.filter(t, n)), 1 < this.length && (H[r] || S.uniqueSort(n), /^(?:parents|prev(?:Until|All))/.test(r) && n.reverse()), this.pushStack(n);
        };
    });
    ;
    function R(e) {
    ...
    S.Callbacks = function (r) {
        var n;
        r = 'string' == typeof r ? (n = {}, S.each(r.match(/[^\x20\t\r\n\f]+/g) || [], function (e, t) {
            ;
        }), n) : S.extend({}, r);
        function i() {
            for (a = a || r.once, t = o = true; u.length; l = -1) {
                for (e = u.shift(); ++l < s.length;) {
                    false === s[l].apply(e[0], e[1]) && r.stopOnFalse && (l = s.length, e = false);
                }
            }
            r.memory || (e = false);
            o = false;
    ...
    S.extend({
                            ...
                            return function () {
                                function e() {
                                    ...
                                    if (!(i < u)) {
                                        ...
                                        x(t) ? s ? t.call(e, l(u, o, R, s), l(u, o, M, s)) : (u++, t.call(e, l(u, o, R, s), l(u, o, M, s), l(u, o, R, o.notifyWith))) : (a !== R && (n = void 0, r = [e]), (s || o.resolveWith)(n, r));
                                    }
                                }
        ...
        when: function (e) {
            ...
            if (n <= 1 && (I(e, a.done(t(r)).resolve, a.reject, !n), 'pending' === a.state() || x(o[r] && o[r].then))) {
                return a.then();
            }
            for (; r--;) {
                I(o[r], t(r), a.reject);
    ...
    S.Deferred.exceptionHook = function (e, t) {
        C.console && C.console.warn && e && /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/.test(e.name) && C.console.warn('jQuery.Deferred exception: ' + e.message, e.stack, t);
    };
    ...
    var $ = function (e, t, n, r, i, o, a) {
        ...
        if ('object' === w(n)) {
            ...
            if (void 0 !== r && (i = true, x(r) || (a = true), l && (t = a ? (t.call(e, r), null) : (l = t, function (e, t, n) {
                    return l.call(S(e), n);
                })), t)) {
                for (; s < u; s++) {
    ...
    function X(e) {
        return e.replace(/^-ms-/, 'ms-').replace(/-([a-z])/g, U);
    }
    function V(e) {
    ...
    G.prototype = {
        ...
        remove: function (e, t) {
            ...
            if (void 0 !== r) {
                if (void 0 !== t) {
                    n = (t = Array.isArray(t) ? t.map(X) : (t = X(t)) in r ? [t] : t.match(/[^\x20\t\r\n\f]+/g) || []).length;
                    for (; n--;) {
                        delete r[t[n]];
                    }
                }
    ...
    function Z(e, t, n) {
        ...
        if (void 0 === n && 1 === e.nodeType) {
            if (r = 'data-' + t.replace(/[A-Z]/g, '-$&').toLowerCase(), 'string' == typeof (n = e.getAttribute(r))) {
                try {
                    n = 'true' === (i = n) || 'false' !== i && ('null' === i ? null : i === +i + '' ? +i : /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/.test(i) ? JSON.parse(i) : i);
                } catch (e) {
                }
                Q.set(e, t, n);
            } else {
    ...
    function le(e, t) {
        for (var n, r, i, o, a, s, u = [], l = 0, c = e.length; l < c; l++) {
            (r = e[l]).style && (n = r.style.display, t ? ('none' === n && (u[l] = Y.get(r, 'display') || null, u[l] || (r.style.display = '')), '' === r.style.display && ae(r) && (u[l] = (s = o = i = void 0, o = r.ownerDocument, a = r.nodeName, (s = ue[a]) || (i = o.body.appendChild(o.createElement(a)), s = S.css(i, 'display'), i.parentNode.removeChild(i), 'none' === s && (s = 'block'), ue[a] = s)))) : 'none' !== n && (u[l] = 'none', Y.set(r, 'display', n)));
        }
        for (l = 0; l < c; l++) {
    ...
    ge.th = ge.td;
    m.option || (ge.optgroup = ge.option = [
        1,
                ...
                if ('object' === w(o)) {
                    ...
                    if (/<|&#?\w+;/.test(o)) {
                        for (a = a || f.appendChild(t.createElement('div')), s = (/<([a-z][^\/\0>\x20\t\r\n\f]*)/i.exec(o) || [
                                '',
                                ''
                            ])[1].toLowerCase(), u = ge[s] || ge._default, a.innerHTML = u[1] + S.htmlPrefilter(o) + u[2], c = u[0]; c--;) {
                            a = a.lastChild;
                        }
        ...
        for (f.textContent = '', d = 0; o = p[d++];) {
            if (r && -1 < S.inArray(o, r)) {
                ...
                if (l = ie(o), a = ve(f.appendChild(o), 'script'), l && ye(a), n) {
                    for (c = 0; o = a[c++];) {
                        /^$|^module$|\/(?:java|ecma)script/i.test(o.type || '') && n.push(o);
                    }
                }
            }
        }
    ...
    function ke(e, t, n, r, i, o) {
        ...
        if (null == r && null == i ? (i = n, r = n = void 0) : null == i && ('string' == typeof n ? (i = r, r = void 0) : (i = r, r = n, n = void 0)), false === i) {
            i = Ee;
        } else {
            if (!i) {
                return e;
    ...
    function Ae(e, i, o) {
        o ? (Y.set(e, i, false), S.event.add(e, i, {
            namespace: false,
            handler: function (e) {
                ...
                if (1 & e.isTrigger && this[i]) {
                    if (r.length) {
                        ...
                        if (r = s.call(arguments), Y.set(this, i, r), t = o(this, i), this[i](), r !== (n = Y.get(this, i)) || t ? Y.set(this, i, false) : n = {}, r !== n) {
    ...
    S.event = {
            ...
            if (V(t)) {
                for (n.handler && (n = (o = n).handler, i = o.selector), i && S.find.matchesSelector(re, i), n.guid || (n.guid = S.guid++), (u = v.events) || (u = v.events = Object.create(null)), (a = v.handle) || (a = v.handle = function (e) {
                    ...
                    d && (f = S.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = S.event.special[d] || {}, c = S.extend({
                        ...
                        namespace: h.join('.')
                    }, o), (p = u[d]) || ((p = u[d] = []).delegateCount = 0, f.setup && false !== f.setup.call(t, r, h, a) || t.addEventListener && t.addEventListener(d, a)), f.add && (f.add.call(t, c), c.handler.guid || (c.handler.guid = n.guid)), i ? p.splice(p.delegateCount++, 0, c) : p.push(c), S.event.global[d] = true);
                }
            }
        },
        remove: function (e, t, n, r, i) {
            ...
            if (v && (u = v.events)) {
                for (l = (t = (t || '').match(/[^\x20\t\r\n\f]+/g) || ['']).length; l--;) {
                    if (d = g = (s = /^([^.]*)(?:\.(.+)|)/.exec(t[l]) || [])[1], h = (s[2] || '').split('.').sort(), d) {
                        ...
                        for (d in u)
                            S.event.remove(e, d + t[l], n, r, true);
                    }
                }
            ...
            if (u.delegateTarget = this, !c.preDispatch || false !== c.preDispatch.call(this, u)) {
                for (a = S.event.handlers.call(this, u, l), t = 0; (i = a[t++]) && !u.isPropagationStopped();) {
                    for (u.currentTarget = i.elem, n = 0; (o = i.handlers[n++]) && !u.isImmediatePropagationStopped();) {
                        u.rnamespace && false !== o.namespace && !u.rnamespace.test(o.namespace) || (u.handleObj = o, u.data = o.data, void 0 !== (r = ((S.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, s)) && false === (u.result = r) && (u.preventDefault(), u.stopPropagation()));
                    }
                }
        ...
        special: {
            ...
            click: {
                setup: function (e) {
                    var t = this || e;
                    return /^(?:checkbox|radio)$/i.test(t.type) && t.click && A(t, 'input') && Ae(t, 'click', Ce), false;
                },
                trigger: function (e) {
                    var t = this || e;
                    return /^(?:checkbox|radio)$/i.test(t.type) && t.click && A(t, 'input') && Ae(t, 'click'), true;
                },
                _default: function (e) {
                    var t = e.target;
                    return /^(?:checkbox|radio)$/i.test(t.type) && t.click && A(t, 'input') && Y.get(t, 'click') || A(t, 'a');
                }
            },
            beforeunload: {
    ...
    S.Event = function (e, t) {
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && false === e.returnValue ? Ce : Ee, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e;
        t && S.extend(this, t);
    ...
    S.each({
        ...
        which: function (e) {
            var t = e.button;
            return null == e.which && /^key/.test(e.type) ? null != e.charCode ? e.charCode : e.keyCode : !e.which && void 0 !== t && /^(?:mouse|pointer|contextmenu|drag|drop)|click/.test(e.type) ? 1 & t ? 1 : 2 & t ? 3 : 4 & t ? 2 : 0 : e.which;
        }
    }, S.event.addProp);
    S.each({
        focus: 'focusin',
    ...
    S.fn.extend({
        ...
        off: function (e, t, n) {
            ...
            if ('object' != typeof e) {
                return false !== t && 'function' != typeof t || (n = t, t = void 0), false === n && (n = Ee), this.each(function () {
    ...
    function Pe(n, r, i, o) {
        ...
        if (h || 1 < f && 'string' == typeof d && !m.checkClone && /checked\s*(?:[^=]|=\s*.checked.)/i.test(d)) {
        ...
        if (f && (t = (e = xe(r, n[0].ownerDocument, false, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
            for (s = (a = S.map(ve(e, 'script'), Le)).length; c < f; c++) {
                u = e;
                c !== p && (u = S.clone(u, true, true), s && S.merge(a, ve(u, 'script')));
                i.call(n[c], u, c);
            }
            if (s) {
                for (l = a[a.length - 1].ownerDocument, S.map(a, He), c = 0; c < s; c++) {
                    u = a[c];
                    /^$|^module$|\/(?:java|ecma)script/i.test(u.type || '') && !Y.access(u, 'globalEval') && S.contains(l, u) && (u.src && 'module' !== (u.type || '').toLowerCase() ? S._evalUrl && !u.noModule && S._evalUrl(u.src, { nonce: u.nonce || u.getAttribute('nonce') }, l) : b(u.textContent.replace(/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, ''), u, l));
                }
            }
        }
        return n;
    ...
    S.extend({
        ...
        clone: function (e, t, n) {
            var r, i, o, a, s, u, l, c = e.cloneNode(true), f = ie(e);
            if (!(m.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || S.isXMLDoc(e))) {
                for (a = ve(c), r = 0, i = (o = ve(e)).length; r < i; r++) {
                    s = o[r];
                    'input' === (l = (u = a[r]).nodeName.toLowerCase()) && /^(?:checkbox|radio)$/i.test(s.type) ? u.checked = s.checked : 'input' !== l && 'textarea' !== l || (u.defaultValue = s.defaultValue);
                }
            }
            if (t) {
                if (n) {
    ...
    S.fn.extend({
        ...
        empty: function () {
            for (var e, t = 0; null != (e = this[t]); t++) {
                1 === e.nodeType && (S.cleanData(ve(e, false)), e.textContent = '');
            }
            return this;
        },
        clone: function (e, t) {
        ...
        html: function (e) {
            return $(this, function (e) {
                ...
                if ('string' == typeof e && !/<script|<style|<link/i.test(e) && !ge[(/<([a-z][^\/\0>\x20\t\r\n\f]*)/i.exec(e) || [
                    ...
                    try {
                        for (; n < r; n++) {
                            1 === (t = this[n] || {}).nodeType && (S.cleanData(ve(t, false)), t.innerHTML = e);
                        }
                        t = 0;
                    } catch (e) {
                    }
    ...
    function Me(e, t, n) {
        var r, i, o = { t: 1 < arguments.length ? s.call(arguments) : e };
        for (i in t)
    ...
    function Ye(e, t, n) {
        ...
        return (n = n || Ve(e)) && ('' !== (a = n.getPropertyValue(t) || n[t]) || ie(e) || (a = S.style(e, t)), !m.pixelBoxStyles() && Xe.test(a) && Ge.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + '' : a;
    }
    function Qe(e, t) {
        return {
            get: function () {
    ...
    (Ue = E.createElement('div')).style && (Ue.style.backgroundClip = 'content-box', Ue.cloneNode(true).style.backgroundClip = '', m.clearCloneStyle = 'content-box' === Ue.style.backgroundClip, S.extend(m, {
    ...
    var Ze = [
            ...
            'Moz',
            'ms'
        ], et = E.createElement('div').style, tt = {};
    function nt(e) {
    ...
    function ut(e, t, n, r, i, o) {
        ...
        for (; a < 4; a += 2) {
            'margin' === n && (u += S.css(e, n + ne[a], true, i));
            r ? ('content' === n && (u -= S.css(e, 'padding' + ne[a], true, i)), 'margin' !== n && (u -= S.css(e, 'border' + ne[a] + 'Width', true, i))) : (u += S.css(e, 'padding' + ne[a], true, i), 'padding' !== n ? u += S.css(e, 'border' + ne[a] + 'Width', true, i) : s += S.css(e, 'border' + ne[a] + 'Width', true, i));
        }
        return !r && 0 <= o && (u += Math.max(0, Math.ceil(e['offset' + t[0].toUpperCase() + t.slice(1)] - o - u - s - 0.5)) || 0), u;
    }
    function lt(e, t, n) {
        var r = Ve(e), i = (!m.boxSizingReliable() || n) && 'border-box' === S.css(e, 'boxSizing', false, r), o = i, a = Ye(e, t, r), s = 'offset' + t[0].toUpperCase() + t.slice(1);
        if (Xe.test(a)) {
            if (!n) {
                return a;
            }
        ...
        return (!m.boxSizingReliable() && i || !m.reliableTrDimensions() && A(e, 'tr') || 'auto' === a || !parseFloat(a) && 'inline' === S.css(e, 'display', false, r)) && e.getClientRects().length && (i = 'border-box' === S.css(e, 'boxSizing', false, r), (o = s in e) && (a = e[s])), (a = parseFloat(a) || 0) + ut(e, t, n || (i ? 'border' : 'content'), o, r, a) + 'px';
    }
    ...
    S.extend({
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = X(t), u = /^--/.test(t), l = e.style;
                if (u || (t = nt(s)), a = S.cssHooks[t] || S.cssHooks[s], void 0 === n) {
                    return a && 'get' in a && void 0 !== (i = a.get(e, false, r)) ? i : l[t];
                }
                'string' == (o = typeof n) && (i = te.exec(n)) && i[1] && (n = se(e, t, i), o = 'number');
                null != n && n == n && ('number' !== o || u || (n += i && i[3] || (S.cssNumber[s] ? '' : 'px')), m.clearCloneStyle || '' !== n || 0 !== t.indexOf('background') || (l[t] = 'inherit'), a && 'set' in a && void 0 === (n = a.set(e, n, r)) || (u ? l.setProperty(t, n) : l[t] = n));
            }
        },
        css: function (e, t, n, r) {
            var i, o, a, s = X(t);
            return /^--/.test(t) || (t = nt(s)), (a = S.cssHooks[t] || S.cssHooks[s]) && 'get' in a && (i = a.get(e, true, n)), void 0 === i && (i = Ye(e, t, r)), 'normal' === i && t in at && (i = at[t]), '' === n || n ? (o = parseFloat(i), true === n || isFinite(o) ? o || 0 : i) : i;
        }
    });
    S.each([
        'height',
        ...
        S.cssHooks[u] = {
            get: function (e, t, n) {
                if (t) {
                    return !/^(none|table(?!-c[ea]).+)/.test(S.css(e, 'display')) || e.getClientRects().length && e.getBoundingClientRect().width ? lt(e, u, n) : Me(e, ot, function () {
                        return lt(e, u, n);
                    });
                }
            },
            set: function (e, t, n) {
                ...
                return a && o && (s -= Math.ceil(e['offset' + u[0].toUpperCase() + u.slice(1)] - parseFloat(i[u]) - ut(e, u, 'border', false, i) - 0.5)), s && (r = te.exec(t)) && 'px' !== (r[3] || 'px') && (e.style[u] = t, t = S.css(e, u)), st(0, t, s);
            }
        };
    });
    S.cssHooks.marginLeft = Qe(m.reliableMarginLeft, function (e, t) {
        if (t) {
            return (parseFloat(Ye(e, 'marginLeft')) || e.getBoundingClientRect().left - Me(e, { marginLeft: 0 }, function () {
    ...
    function wt(o, e, t) {
        var n, a, r = 0, i = wt.prefilters.length, s = S.Deferred().always(function () {
                ...
                for (var e = ft || mt(), t = Math.max(0, l.startTime + l.duration - e), n = 1 - (t / l.duration || 0), r = 0, i = l.tweens.length; r < i; r++) {
                    l.tweens[r].run(n);
                }
        ...
        for (function (e, t) {
            ...
            if (n = wt.prefilters[r].call(l, o, c, l.opts)) {
                return x(n.stop) && (S._queueHooks(l.elem, l.opts.queue).stop = n.stop.bind(n)), n;
            }
        }
        return S.map(c, bt, l), x(l.opts.start) && l.opts.start.call(o, l), l.progress(l.opts.progress).done(l.opts.done, l.opts.complete).fail(l.opts.fail).always(l.opts.always), S.fx.timer(S.extend(u, {
            elem: o,
            anim: l,
            queue: l.opts.queue
        })), l;
    ...
    S.Animation = S.extend(wt, {
        ...
        tweener: function (e, t) {
            for (var n, r = 0, i = (e = x(e) ? (t = e, ['*']) : e.match(/[^\x20\t\r\n\f]+/g)).length; r < i; r++) {
                n = e[r];
        ...
        prefilters: [function (e, t, n) {
                var r, i, o, a, s, u, l, c, f = 'width' in t || 'height' in t, p = this, d = { r: v && v[r] || S.style(e, r) }, h = e.style, g = e.nodeType && ae(e), v = Y.get(e, 'fxshow');
                ...
                if ((u = !S.isEmptyObject(t)) || !S.isEmptyObject(d)) {
                    for (r in (f && 1 === e.nodeType && (n.overflow = [
                            ...
                            h.overflowX,
                            h.overflowY
                        ], null == (l = v && v.display) && (l = Y.get(e, 'display')), 'none' === (c = S.css(e, 'display')) && (l ? c = l : (le([e], true), l = e.style.display || l, c = S.css(e, 'display'), le([e]))), ('inline' === c || 'inline-block' === c && null != l) && 'none' === S.css(e, 'float') && (u || (p.done(function () {
                            h.display = l;
                        ...
                        u || (v ? 'hidden' in v && (g = v.hidden) : v = Y.access(e, 'fxshow', { display: l }), o && (v.hidden = !g), g && le([e], true), p.done(function () {
    ...
    S.fn.extend({
        ...
        stop: function (i, e, o) {
            ...
            return 'string' != typeof i && (o = e, e = i, i = void 0), e && this.queue(i || 'fx', []), this.each(function () {
                ...
                if (t) {
                    ...
                    for (t in r)
                        r[t] && r[t].stop && /queueHooks$/.test(t) && a(r[t]);
                }
                for (t = n.length; t--;) {
                    n[t].elem !== this || null != i && n[t].queue !== i || (n[t].anim.stop(o), e = false, n.splice(t, 1));
                }
        ...
        finish: function (a) {
            return false !== a && (a = a || 'fx'), this.each(function () {
                ...
                for (t.finish = true, S.queue(this, a, []), r && r.stop && r.stop.call(this, true), e = i.length; e--;) {
                    i[e].elem === this && i[e].queue === a && (i[e].anim.stop(true), i.splice(e, 1));
                }
                for (e = 0; e < o; e++) {
    ...
    S.extend({
        attr: function (e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o) {
                return void 0 === e.getAttribute ? S.prop(e, t, n) : (1 === o && S.isXMLDoc(e) || (i = S.attrHooks[t.toLowerCase()] || (S.expr.match.bool.test(t) ? Tt : void 0)), void 0 !== n ? null === n ? void S.removeAttr(e, t) : i && 'set' in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ''), n) : !(i && 'get' in i && null !== (r = i.get(e, t))) && null == (r = S.find.attr(e, t)) ? void 0 : r);
            }
        },
        attrHooks: {
            type: {
        ...
        toggleClass: function (i, t) {
            ...
            return 'boolean' == typeof t && a ? t ? this.addClass(i) : this.removeClass(i) : x(i) ? this.each(function (e) {
                ...
                if (a) {
                    ...
                    void 0 !== i && 'boolean' != o || ((e = At(this)) && Y.set(this, '__className__', e), this.setAttribute && this.setAttribute('class', !e && false !== i && Y.get(this, '__className__') || ''));
                }
            });
        },
        hasClass: function (e) {
    ...
    S.fn.extend({
        val: function (n) {
            ...
            })) : t ? (r = S.valHooks[t.type] || S.valHooks[t.nodeName.toLowerCase()]) && 'get' in r && void 0 !== (e = r.get(t, 'value')) ? e : 'string' == typeof (e = t.value) ? e.replace(/\r/g, '') : null == e ? '' : e : void 0;
        }
    });
    S.extend({
        valHooks: {
            ...
            select: {
                ...
                set: function (e, t) {
                    for (var n, r, i = e.options, o = S.makeArray(t), a = i.length; a--;) {
                        ((r = i[a]).selected = -1 < S.inArray(S.valHooks.option.get(r), o)) && (n = true);
                    }
    ...
    S.extend(S.event, {
        trigger: function (e, t, n, r) {
            ...
            if (o = f = a = n = n || E, 3 !== n.nodeType && 8 !== n.nodeType && !/^(?:focusinfocus|focusoutblur)$/.test(d + S.event.triggered) && (-1 < d.indexOf('.') && (d = (h = d.split('.')).shift(), h.sort()), u = d.indexOf(':') < 0 && 'on' + d, (e = e[S.expando] ? e : new S.Event(d, 'object' == typeof e && e)).isTrigger = r ? 2 : 3, e.namespace = h.join('.'), e.rnamespace = e.namespace ? new RegExp('(^|\\.)' + h.join('\\.(?:.*\\.|)') + '(\\.|$)') : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : S.makeArray(t, [e]), c = S.event.special[d] || {}, r || !c.trigger || false !== c.trigger.apply(n, t))) {
                if (!r && !c.noBubble && !g(n)) {
                    for (s = c.delegateType || d, /^(?:focusinfocus|focusoutblur)$/.test(s + d) || (o = o.parentNode); o; o = o.parentNode) {
                        p.push(o);
                        a = o;
                    }
                ...
                for (i = 0; (o = p[i++]) && !e.isPropagationStopped();) {
                    ...
                    (l = u && o[u]) && l.apply && V(o) && (e.result = l.apply(o, t), false === e.result && e.preventDefault());
                }
                return e.type = d, r || e.isDefaultPrevented() || c._default && false !== c._default.apply(p.pop(), t) || !V(n) || u && x(n[d]) && !g(n) && ((a = n[u]) && (n[u] = null), S.event.triggered = d, e.isPropagationStopped() && f.addEventListener(d, jt), n[d](), e.isPropagationStopped() && f.removeEventListener(d, jt), S.event.triggered = void 0, a && (n[u] = a)), e.result;
            }
        },
    ...
    var Lt = C.location, Ht = { guid: Date.now() };
    ...
    function Wt(n, e, r, i) {
        ...
        if (Array.isArray(e)) {
            S.each(e, function (e, t) {
                r || /\[\]$/.test(n) ? i(n, t) : Wt(n + '[' + ('object' == typeof t && null != t ? e : '') + ']', t, r, i);
            });
        } else {
            if (r || 'object' !== w(e)) {
                i(n, e);
    ...
    S.fn.extend({
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !S(this).is(':disabled') && /^(?:input|select|textarea|keygen)/i.test(this.nodeName) && !/^(?:submit|button|image|reset|file)$/i.test(e) && (this.checked || !/^(?:checkbox|radio)$/i.test(e));
            }).map(function (e, t) {
                var n = S(this).val();
    ...
    var Xt = {}, Vt = {}, Gt = '*/'.concat('*'), Yt = E.createElement('a');
    function Qt(o) {
        return function (e, t) {
            'string' != typeof e && (t = e, e = '*');
            var n, r = 0, i = e.toLowerCase().match(/[^\x20\t\r\n\f]+/g) || [];
            if (x(t)) {
                for (; n = i[r++];) {
    ...
    S.extend({
        ...
        ajax: function (e, t) {
            ...
            if (x.promise(T), v.url = ((e || v.url || Lt.href) + '').replace(/^\/\//, Lt.protocol + '//'), v.type = t.method || t.type || v.method || v.type, v.dataTypes = (v.dataType || '*').toLowerCase().match(/[^\x20\t\r\n\f]+/g) || [''], null == v.crossDomain) {
                r = E.createElement('a');
                try {
                    r.href = v.url;
                    r.href = r.href;
                    v.crossDomain = Yt.protocol + '//' + Yt.host != r.protocol + '//' + r.host;
                } catch (e) {
                    v.crossDomain = true;
                }
            }
            if (v.data && v.processData && 'string' != typeof v.data && (v.data = S.param(v.data, v.traditional)), Jt(Xt, v, t, T), h) {
                return T;
            }
            for (i in ((g = S.event && v.global) && 0 == S.active++ && S.event.trigger('ajaxStart'), v.type = v.type.toUpperCase(), v.hasContent = !/^(?:GET|HEAD)$/.test(v.type), f = v.url.replace(/#.*$/, ''), v.hasContent ? v.data && v.processData && 0 === (v.contentType || '').indexOf('application/x-www-form-urlencoded') && (v.data = v.data.replace(/%20/g, '+')) : (o = v.url.slice(f.length), v.data && (v.processData || 'string' == typeof v.data) && (f += (/\?/.test(f) ? '&' : '?') + v.data, delete v.data), false === v.cache && (f = f.replace(/([?&])_=[^&]*/, '$1'), o = (/\?/.test(f) ? '&' : '?') + '_=' + Ht.guid++ + o), v.url = f + o), v.ifModified && (S.lastModified[f] && T.setRequestHeader('If-Modified-Since', S.lastModified[f]), S.etag[f] && T.setRequestHeader('If-None-Match', S.etag[f])), (v.data && v.hasContent && false !== v.contentType || t.contentType) && T.setRequestHeader('Content-Type', v.contentType), T.setRequestHeader('Accept', v.dataTypes[0] && v.accepts[v.dataTypes[0]] ? v.accepts[v.dataTypes[0]] + ('*' !== v.dataTypes[0] ? ', ' + Gt + '; q=0.01' : '') : v.accepts['*']), v.headers))
                T.setRequestHeader(i, v.headers[i]);
            if (v.beforeSend && (false === v.beforeSend.call(y, T, v) || h)) {
                return T.abort();
            }
            if (u = 'abort', b.add(v.complete), T.done(v.success), T.fail(v.error), c = Jt(Vt, v, t, T)) {
            ...
            function l(e, t, n, r) {
                ...
                h || (h = true, d && C.clearTimeout(d), c = void 0, p = r || '', T.readyState = 0 < e ? 4 : 0, i = 200 <= e && e < 300 || 304 === e, n && (s = function (e, t, n) {
                    ...
                    var i, o, a, s, u, l = { o: (s ? '#' + s : ':scope') + ' ' + xe(l[o]) }, c = e.dataTypes.slice();
                    if (c[1]) {
    ...
    S.fn.extend({
        wrapAll: function (e) {
            var t;
            return this[0] && (x(e) && (e = e.call(this[0])), t = S(e, this[0].ownerDocument).eq(0).clone(true), this[0].parentNode && t.insertBefore(this[0]), t.map(function () {
    ...
    S.ajaxPrefilter('json jsonp', function (e, t, n) {
        var r, i, o, a = false !== e.jsonp && (/(=)\?(?=&|$)|\?\?/.test(e.url) ? 'url' : 'string' == typeof e.data && 0 === (e.contentType || '').indexOf('application/x-www-form-urlencoded') && /(=)\?(?=&|$)|\?\?/.test(e.data) && 'data');
        if (a || 'jsonp' === e.dataTypes[0]) {
            return r = e.jsonpCallback = x(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(/(=)\?(?=&|$)|\?\?/, '$1' + r) : false !== e.jsonp && (e.url += (/\?/.test(e.url) ? '&' : '?') + e.jsonp + '=' + r), e.converters['script json'] = function () {
    ...
    S.parseHTML = function (e, t, n) {
        return 'string' != typeof e ? [] : ('boolean' == typeof t && (n = t, t = false), t || (m.createHTMLDocument ? ((r = (t = E.implementation.createHTMLDocument('')).createElement('base')).href = E.location.href, t.head.appendChild(r)) : t = E), o = !n && [], (i = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i.exec(e)) ? [t.createElement(i[1])] : (i = xe([e], t, o), o && o.length && S(o).remove(), S.merge([], i.childNodes)));
        var r, i, o;
    };
    S.fn.load = function (e, t, n) {
        var r, i, o, a = this, s = e.indexOf(' ');
        return -1 < s && (r = kt(e.slice(s)), e = e.slice(0, s)), x(t) ? (n = t, t = void 0) : t && 'object' == typeof t && (i = 'POST'), 0 < a.length && S.ajax({
            url: e,
            type: i || 'GET',
            dataType: 'html',
            data: t
        ...
        position: function () {
            if (this[0]) {
                ...
                return {
                    ...
                    left: t.left - 0 - S.css(r, 'marginLeft', true)
                };
            }
        },
    ...
    S.each({
        ...
        S.fn[t] = function (e) {
            return $(this, function (e, t, n) {
                var r;
                if (g(e) ? r = e : 9 === e.nodeType && (r = e.defaultView), void 0 === n) {
                    return r ? r[i] : e[t];
                }
    ...
    S.each([
        ...
        S.cssHooks[n] = Qe(m.pixelPosition, function (e, t) {
            if (t) {
                return t = Ye(e, n), Xe.test(t) ? S(e).position()[n] + 'px' : t;
            }
        });
    });
    S.each({
